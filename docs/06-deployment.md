# Deployment - Deploy-ის გაიდი

> 🚀 **Production deployment Railway-ზე და domain კონფიგურაცია**
...
```bash
□ ყველა ფუნქცია ტესტირებულია ლოკალურად
□ No console.logs left in production code
□ Environment variables დოკუმენტირებულია
□ Database migrations მზადაა
□ Tests გადის
...
□ Bundle size acceptable (check pnpm build output)
```
...
```
CNAME record:
digitalmenu.ge → <your-app>.railway.app
```
...
```bash
□ Site loads: https://digitalmenu.ge
...
თქვენი აპლიკაცია ახლა live-ზეა!
